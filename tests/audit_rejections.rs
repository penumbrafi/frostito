//! Audit regression tests — the rejection paths named as untested.
//!
//! The 0.4.0 suite has the right shape: one un-ignored test per finding,
//! performing the attack and asserting it fails. of
//! the 2026-09-21 maintainer review observed that the *negative* half was
...
mod a_forged_round1_package_is_refused {
 ...
 Error::InvalidProofOfKnowledge(2),
 ...
 Error::InvalidProofOfKnowledge(1)
 );
...
mod the_four_sealed_rejection_paths {
 ...
 // (7) digest mismatch — the package opens, but the commitment it
